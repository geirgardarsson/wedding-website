<script lang="ts">
    ...
    function scrollToRegisterMyself() {
      const foodSection = document.getElementById("rsvp-section");
  ...
  <Section sectionId="spouse-rsvp-section" backgroundColor="bg-cyan-400">
      <div class="h-screen w-full md:w-96 m-auto flex flex-col">
        ...
        <div class="m-auto mx-6">
          <Button
            ...
            text={isRegistered ? `${firstName} hlakkar til að mæta!!` : "Maki ætlar að mæta!!"}
